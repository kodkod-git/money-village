...
assert(
  /\.efti-report-name\s*\{\s*top:\s*10\.8%;\s*left:\s*17\.5%;\s*\}/.test(css) &&
    /\.efti-report-age\s*\{\s*top:\s*10\.8%;\s*left:\s*47\.5%;\s*\}/.test(css) &&
    /\.efti-report-date\s*\{\s*top:\s*10\.8%;\s*left:\s*78\.5%;\s*\}/.test(css),
